# copy from https://github.com/capsule2077/label-convert
import json
import shutil
...
def move_images(origin_images_dir, filename, path):
    ...
    shutil.copy(origin_images_dir, dst)
...
if __name__ == "__main__":
    # yolo格式数据根目录
    root_dir = Path("/usr/local/google/home/yuyanwang/Documents/pysources/ultralytics-main/datasets/1k")
    # 自动区分是否有训练/验证/测试集
    # 所以一般无需更改type_list
